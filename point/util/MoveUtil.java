...
public final class MoveUtil {
    ...
    public void setEventMotionSpeed(final EventMotion EventMotion, final double moveSpeed) {
        setEventMotion(EventMotion, moveSpeed, mc.thePlayer.rotationYaw, mc.thePlayer.movementInput.moveStrafe, mc.thePlayer.movementInput.moveForward);
    }
    ...
    public void setEventMotion(final EventMotion EventMotion, final double moveSpeed, final float pseudoYaw, final double pseudoStrafe, final double pseudoForward) {
        ...
        EventMotion.setX(forward * moveSpeed * mx + strafe * moveSpeed * mz);
        EventMotion.setZ(forward * moveSpeed * mz - strafe * moveSpeed * mx);
    }
